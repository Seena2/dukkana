...
export function useProducts(){
    ...
    const getProducts= useCallback(async(params?:ProductQueryParams):Promise<ProductsResponse | null>=>{
        ...
        try {
            // fetch products from backend using productService and set products and meta for pagiantion
    ...
    return {isLoading,products, getProducts, error,meta, product, getProduct}
}